...
![computer_vision_2](/assets/pictures/computer_vision_2.jpg){:class="img-responsive"}*This diagram shows the four most common methods for image processing. Data that comes into the sensors is often noisy and incapable of being used in their raw form. Therefore, scientists do the best they can to clean and eliminate any irrelevant data.*
